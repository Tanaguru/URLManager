...
public interface LocaleDAO extends GenericDAO<Locale, Long> {
     ...
     */
    List<Locale> findLocaleListFromLanguage(String language);
     ...
     *         Return an empty list if there is no match.
     */
    List<Locale> findLocaleListFromCountry(String country);
     ...
     *         Return an empty list if there is no match.
     */
    List<Locale> findLocaleListFromLongLanguage(String longLanguage);
     ...
     *         Return an empty list if there is no match.
     */
    List<Locale> findLocaleListFromLongCountry(String longCountry);
     ...
     */
    Locale findLocaleFromLanguageAndCountry(String language, String country);
     ...
     *         Return null if there is no match.
     */
    Locale findLocaleFromLongLanguageAndLongCountry(
            String longLanguage,
            String longCountry);
}
