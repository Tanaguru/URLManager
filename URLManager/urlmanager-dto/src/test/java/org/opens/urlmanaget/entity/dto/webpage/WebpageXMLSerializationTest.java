 ...
 */
package org.opens.urlmanaget.entity.dto.webpage;
 ...
 * @author bcareil
 */
public class WebpageXMLSerializationTest extends TestCase {

    public WebpageXMLSerializationTest(String name) {
        super(name);
    }
    ...
    public void testWebpageSerialization()
            throws Exception {
        ...
        WebpageDTO webpage = createWebpage();
    ...
    private WebpageDTO createWebpage() {
