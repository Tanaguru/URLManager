 ...
 * @author bcareil
 */
public class TagXMLSerializationTest extends XMLTestCase {

    private static final String EXPECTED_OUTPUT_FILENAME =
            "src/test/resources/tag/expected-output.xml";
    ...
    public void testTagSerialization()
        ...
        System.out.println("-> tag entity marshalled :");
